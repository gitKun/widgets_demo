...
class _OptionsItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // debugPrint('textScaleFactor = $textScaleFactor ____#');
...
class _ThemeItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _BooleanItem(
      ...
      (bool value) {
        onOptionsChanged(options.copyWhid(
        ...
        children: <Widget>[
          ...
          PopupMenuButton<GalleryTextScaleValue>(
            ...
            onSelected: (GalleryTextScaleValue scaleValue) {
              onOptionsChanged(
                options.copyWhid(textScaleFactor: scaleValue),
              );
            },
          ),
        ],
        ...
        children: <Widget>[
          ...
          PopupMenuButton<TargetPlatform>(
            ...
            onSelected: (TargetPlatform platform) {
              onOptionsChanged(
                options.copyWhid(platform: platform),
              );
            },
          ),
        ],
...
class GalleryOptionsPage extends StatelessWidget {
  ...
  List<Widget> _enabledDiagnosticItems() {
    // 值为null的Boolean showFoo选项:完全不显示showFoo选项
    ...
    if (options.showOffscreenLayersCheckerboard != null) {
      items.add(
        _BooleanItem(
          ...
          (bool value) {
            onOptionsChanged(
              options.copyWhid(showOffscreenLayersCheckerboard: value),
            );
          },
        ),
      );
    ...
    if (options.showRasterCacheImagesCheckerboard != null) {
      items.add(
        _BooleanItem(
          'Hightlight raster cache images',
          options.showRasterCacheImagesCheckerboard,
          (bool value) {
            onOptionsChanged(
              options.copyWhid(showRasterCacheImagesCheckerboard: value),
            );
          },
        ),
      );
    ...
    if (options.showPerformanceOverlay != null) {
      items.add(
        _BooleanItem(
          ...
          (bool value) {
            onOptionsChanged(
              options.copyWhid(showPerformanceOverlay: value),
            );
          },
        ),
      );
