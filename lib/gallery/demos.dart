...
List<GalleryDemo> _buildGalleryDemos() {
  final List<GalleryDemo> galleryDemos = <GalleryDemo>[
    ...
    //   buildRoute: null, //(BuildContext context) => const ShrineDemo(),
    // ),
    // GalleryDemo(
    //   title: 'Fortnightly',
    ...
    //   buildRoute: null, //(BuildContext context) => FortnightlyDemo(),
    // ),
    // GalleryDemo(
    ...
    //   buildRoute: null, //(BuildContext context) => ContactsDemo(),
    // ),
    // GalleryDemo(
    //   title: 'Animation',
    ...
    //   buildRoute: null, //(BuildContext context) => const AnimationDemo(),
    // ),
    // GalleryDemo(
    ...
    //   buildRoute: null, //(BuildContext context) => const TransformationsDemo(),
    // ),
    ...
    //   buildRoute: null, //(BuildContext context) => ColorsDemo(),
    // ),
    // GalleryDemo(
    //   title: 'Typography',
    ...
    //   buildRoute: null, //(BuildContext context) => TypographyDemo(),
    // ),
    ...
    //   buildRoute: null, //(BuildContext context) => BackdropDemo(),
    // ),
    // GalleryDemo(
    ...
    //   buildRoute: null, //(BuildContext context) => BottomAppBarDemo(),
    // ),
    // GalleryDemo(
    ...
    //   buildRoute: null, //(BuildContext context) => BottomNavigationDemo(),
    // ),
    // GalleryDemo(
